                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-xl-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('firstName') is-invalid @enderror" type="text" name="firstName" placeholder="First Name" required="required">
                                </div>
                                @error('firstName')
                            ...
                            <div class="col-md-4 mb-xl-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('middleName') is-invalid @enderror" type="text" name="middleName" placeholder="Middle Name">
                                </div>
                                @error('middleName')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-4 mb-xl-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('lastName') is-invalid @enderror" type="text" name="lastName" placeholder="Last name" required="required">
                                    @error('lastName')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6 mb-xl-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('BirthDate') is-invalid @enderror" type="date" placeholder="BIRTHDATE" name="BirthDate" required="required">
                                    @error('BirthDate')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6 mb-xl-3">
                                ...
                                <div class="form-flex row">
                                    <div class="col-4">
                                        <input type="radio" class="@error('gender') is-invalid @enderror" name="gender" value="male" id="male" checked="checked" required="required">
                            ...
                            <div class="col-md-6 mb-xl-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('email') is-invalid @enderror" type="email" name="email" placeholder="Mohammed0012@gmail.com">
                                    @error('email')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6 mb-xl-3">
                                <div class="form-group">
                                    ...
                                    <input name="phoneNumber" type="tel" placeholder="Phone Number" class="@error('phoneNumber') is-invalid @enderror form-control" style="padding-left: 140px">
                                    @error('phoneNumber')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                    <!-- country codes (ISO 3166) and Dial codes. -->
                                    <select style="position:relative; bottom:38px; width: 38%;" name="countryCode" id="" class="form-control">
                            ...
                            <div class="col-md-6 mb-xl-3">
                                <div class="form-group">
                                    ...
                                    <input id = "psw"pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" class="form-control @error('password') is-invalid @enderror" type="password" name="password" placeholder="Password" required="required">
                                    <div id="message">
                            ...
                            <div class="col-12 text-center mb-5 mt-5">
                                <button onclick="phoneAuth();" id = "sign-in-button" type="submit"  class="h4 col-9 btn btn-primary font-weight-400 mr-auto ml-auto">Submite</button>
                            </div>
                        </div>
                    </form>
                </div>
