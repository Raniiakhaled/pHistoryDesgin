        ...
        <div class="container">
            <div class="row d-flex justify-content-center">
                <div class="col-md-10">
                    ...
                    @endforeach
                    <form role="form" enctype="multipart/form-data" action="{{route('xray_post_Register')}}"  method="POST" class="login-box">
                        {{ csrf_field() }}
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-xl-3">
                                <div class="form-group">
                                    <label class="h5 font-weight-bold">X-Ray Name</label>
                                    <input class="form-control" type="text" name="xrayName" placeholder="X-Ray Name">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 mb-xl-3">
                                <div class="form-group">
                                    <label class="h5 font-weight-bold">X-ray License</label>
                                    <input class="form-control" type="file" placeholder="X-ray License" name="xray_License">
                                </div>
                            </div>
                            <div class="col-md-10">
                                <div class="form-group">
                                    <label class="h5 font-weight-bold">Phone Number</label>
                                    <input class="form-control" type="tel" name="phoneNumber" placeholder="Phone Number" style="padding-left: 230px">
                            ...
                            <label class=" col-12 h5 font-weight-bold">Add Dapartment</label> 
                                <div class="form-flex row">
                                    <div class="col-6">
                                        <input type="checkbox" name="is_labs" value="1">
                                        <label class="h5 ml-3 mt-3 ">Labs</label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12 mb-xl-3">
