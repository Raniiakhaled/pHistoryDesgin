            ...
            <div class="container-fluid" style="margin-top: 160px; margin-bottom: 220px;">
                <div class="header">
                    <div class="container-fluid row mt-5 mb-5 text-center">
                            <div class="col-md-3">
                                <a href="{{route('xray.profile',$xray->id)}}"><img class="" src="{{url('imgs/x-rays.png')}}" height="" width="150" alt="Responsive image"></a>
                            </div>

                        @if($xray->is_labs == 1)
                            <div class="col-md-3">
                                <a href="#"><img class="" src="{{url('imgs/labs.png')}}" height="" width="150" alt="Responsive image"></a>
                            </div>
                        @endif
                    </div>
                </div>
