                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-xl-3">
                            <div class="form-group">
                                <label class="h5 font-weight-bold">Clinic Name</label>
                                <input class="form-control @error('clinicName') is-invalid @enderror" type="text" name="clinicName" placeholder="Clinic Name">
                                @error('clinicName')
                        ...
                        <div class="col-md-6 mb-xl-3">
                            <div class="form-group">
                                <label class="h5 font-weight-bold">Primary Speciality</label>
                        ...
                        <div class="col-md-6 mb-xl-3">
                            <div class="form-group">
                                <label class="h5 font-weight-bold">Medical License Namber</label>
                                <input class="form-control @error('Medical_License_Number') is-invalid @enderror" type="text" placeholder="Medical License Namber" name="Medical_License_Number">
                        ...
                        <div class="col-md-6 mb-xl-3">
                            <div class="form-group">
                                <label class="h5 font-weight-bold">Degree</label>
                                <select class="form-control @error('degree') is-invalid @enderror" name="degree">
                        ...
                        <div class="col-md-6 mb-xl-3">
                            <div class="form-group">
                                <label class="h5 font-weight-bold">Medical description</label>
                                <input class="form-control @error('medical_description') is-invalid @enderror" type="text" placeholder="medical_description" name="medical_description">
                        ...
                        <div class="col-md-6 mb-xl-3">
                            <div class="form-group">
                                <label class="h5 font-weight-bold">Clinic License</label>
                        ...
                        <div class="col-md-10 mb-xl-3">
                            <div class="form-group">
                                ...
                                <input class="form-control @error('phoneNumber') is-invalid @enderror" type="text" name="phoneNumber" placeholder="Phone Number" style="padding-left: 220px">
                                @error('phoneNumber')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-md-6 mb-xl-3">
                            <div class="form-group">
                                <label class="h5 font-weight-bold">Telephone</label>
                                <input class="form-control @error('phoneNumber') is-invalid @enderror" type="text" name="telephone" placeholder="Telephone">
                                @error('telephone')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6 mb-xl-3">
                            <div class="form-group">
                                <label class="h5 font-weight-bold">Hotline</label>
                                <input class="form-control @error('Hotline') is-invalid @enderror" type="text" name="Hotline" placeholder="Hotline">
                                @error('Hotline')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6 mb-xl-3">
                            <div class="form-group">
                                <label class="h5 font-weight-bold">Country</label>
                                <input class="form-control @error('country') is-invalid @enderror" type="text" name="country" placeholder="Country">
                                @error('country')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6 mb-xl-3">
                            <div class="form-group">
                                <label class="h5 font-weight-bold">City</label>
                                <input class="form-control @error('city') is-invalid @enderror" type="text" name="city" placeholder="City">
                                @error('city')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4 mb-xl-3">
                            <div class="form-group">
                                <label class="h5 font-weight-bold">Area</label>
                                <input class="form-control @error('area') is-invalid @enderror" type="text" name="area" placeholder="Area">
                                @error('area')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4 mb-xl-3">
                            <div class="form-group">
                                <label class="h5 font-weight-bold">Street</label>
                                <input class="form-control @error('street') is-invalid @enderror" type="text" name="street" placeholder="Street">
                                @error('street')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4 mb-xl-3">
                            <div class="form-group">
                                <label class="h5 font-weight-bold">ZIP Code</label>
                                <input class="form-control @error('zip_code') is-invalid @enderror" type="text" name="zip_code" placeholder="ZIP Code">
                                @error('zip_code')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <label class="col-12 h5 font-weight-bold">Add Dapartment</label> 
                        <div class="col-md-4 mb-xl-3">
                            <input type="checkbox" name="clinic_labs" value="1">
                            <label class="h5 ml-3">Add Lab</label>
                        </div>
                        <div class="col-md-4 mb-xl-3">
                            <input type="checkbox" name="clinic_xray" value="1">
                            <label class="h5 ml-3 ">Add Xray</label>
                        </div>
                        <div class="col-md-4 mb-xl-3">
                            <input type="checkbox" name="clinic_pharmacy" value="1">
                            <label class="h6 ml-3 ">Add pharmacy</label>
                        </div>
                        <div class="col-md-12 mb-xl-3">
                                <hr class="my-4" />
                                <div class="">
                                    <input type="checkbox" name="is_xrays" value="1">
                                    <label class="p font-weight-bold ml-3">I agree to patient history <a class="text-primary" href="#">terms of service</a> and <a class="text-primary" href="#">privacy policy</a></label>
                                </div>
                        </div>
                        <div class="col-12 text-center mb-5 mt-5">
                            <button type="submit" class=" col-9 btn btn-primary font-weight-600 h3 mr-auto ml-auto">Submite</button>
                        </div>
                    </div>
                </form>
            </div>
