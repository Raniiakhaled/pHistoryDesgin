                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-xl-3">
                                <div class="form-group">
                                    <label class="h5 font-weight-bold">Pharmacy Name</label>
                            ...
                            <div class="col-md-6 mb-xl-3">
                                <div class="form-group">
                                    <label class="h5 font-weight-bold">Pharmacy License</label>
                                    <input class="form-control" type="file" placeholder="Pharmacy License" name="pharmacy_License">
                                </div>
                            </div>
                            <div class="col-md-10">
                                <div class="form-group">
                                    <label class="h5 font-weight-bold">Phone Number</label>
                                    <input class="form-control" type="text" name="phoneNumber" placeholder="Phone Number"  style="padding-left: 230px">
                            ...
                            <div class="col-md-6 mb-xl-3">
                                <div class="form-group">
                                    <label class="h4 font-weight-bold">Country</label>
