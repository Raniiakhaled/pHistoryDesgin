...
@section('title','Hosptail Register')
@section('content')
    ...
    <div class="container">
        <div class="row d-flex justify-content-center">
            <div class="col-md-10">
                ...
                @endforeach
                <form enctype="multipart/form-data" role="form" action="{{route('hosptail_post_Register')}}" class="login-box" method="POST">
                    {{ csrf_field() }}
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-xl-3">
                            <div class="form-group">
                                <label class="h5 font-weight-bold">Hospital Name</label>
                                <input class="form-control" type="text" name="hosptailName" placeholder="Hospital Name">
                            </div>
                        </div>
                        <div class="col-md-6 mb-xl-3">
                            <div class="form-group">
                        ...
                        <div class="col-md-6 mb-xl-3">
                            <div class="form-group">
                                ...
                                <input  name = "Medical_License_Number" class="form-control" type="text" placeholder="Medical License Namber">
                            </div>
                        </div>
                        <div class="col-md-6 mb-xl-3">
                            <div class="form-group">
                                <label class="h5 font-weight-bold">Hospital License</label>
                        ...
                        <div class="col-md-10 mb-xl-3">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="phoneNumber" placeholder="Phone Number" style="padding-left: 220px">
