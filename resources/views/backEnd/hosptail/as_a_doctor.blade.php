            ...
            <div class="container-fluid" style="margin-top: 160px; margin-bottom: 220px;">
              <div class="header">
                <div class="container-fluid row mt-5 mb-5 text-center">
                  <div class="col-md-3">
                    <a href="{{route('loginDoctor',$hosptail->id)}}"><img class="" src="{{url('imgs/doctor.png')}}" height="" width="150" alt="Responsive image"></a>
                  </div>
                  @if($hosptail->hosptail_xray == 1)
                  <div class="col-md-3">
                    <a href="{{route('get_search_xray',$hosptail->id)}}"><img class="" src="{{url('imgs/x-rays.png')}}" height="" width="150" alt="Responsive image"></a>
                  </div>
                  @endif
                  @if($hosptail->hosptail_labs == 1)
                  <div class="col-md-3">
                    <a href="{{route('get_search_lab',$hosptail->id)}}"><img class="" src="{{url('imgs/labs.png')}}" height="" width="150" alt="Responsive image"></a>
                  </div>
                  @endif
                  @if($hosptail->hosptail_pharmacy == 1)
                  <div class="col-md-3">
                    <a href="{{route('get_search_pharmacy',$hosptail->id)}}"><img class="" src="{{url('imgs/pharmacy.png')}}" height="" width="150" alt="Responsive image"></a>
                  </div>
                  @endif
                </div>
              </div>
