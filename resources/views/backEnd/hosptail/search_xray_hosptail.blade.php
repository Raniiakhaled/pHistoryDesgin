            ...
            <!-- Modal -->
              <div class="modal fade" id="Testing" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="exampleModalLabel">Ridolgy </h5>
                      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                      </button>
                    </div>
                    <div class="modal-body">
                      <div class="col-md-12">
                        <div class="pills-main pills-main-yellow col-xl-8 col-md-4 col-xs-12 row mb-4 mr-auto ml-auto">
                          @foreach($patient->patient_rays as $rays)
                          <div class="col-12">
                            <h5 class="mt-4 float-right">{{$rays['created_at']}}</h5>
                          </div>
                          
                          <div class="row col-12 mb-3">
                            
                            <div class="col-4">
                              <h5 class="font-weight-bold">Ridolgy</h5>
                            </div>
                            ...
                            <div class="col-8">
                                ...
                                <h5>
                                  {{$rays['name']}} 
                                  <form class="mt-3" action="{{route('add_Result_rays',$hosptail->id)}}" method="POST" enctype="multipart/form-data">
                                    {{csrf_field()}}
                                    <input type="hidden" name="rays_id" value="{{$rays->id}}">    
