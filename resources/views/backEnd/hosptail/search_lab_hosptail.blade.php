              ...
              <div class="modal fade" id="Testing" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <div class="col-md-12">
                        @foreach($patient->patient_analzes as $analzes)
                        <div class="pills-main pills-main-yellow col-xl-8 col-md-4 col-xs-12 row mb-4 mr-auto ml-auto">
                          ...
                          <div class="row col-12 mb-3">
                            ...
                            <div class="col-8">
                                ...
                                <h5>
                                {{$analzes['name']}}
                                <form class="mt-3" action="{{route('add_Result_analzes',$hosptail->id)}}" method="POST" enctype="multipart/form-data">
                                    {{csrf_field()}}
                                    <input type="hidden" name="analzes_id" value="{{$analzes->id}}">    
