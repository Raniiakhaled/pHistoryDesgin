...
<div class="back-ground">
    <div class="container-fluid row no-gutters mt-5 mb-3 bg-message card">
        ...
        <div class="col-lg-6 paddingT order-lg-1 mt-5 mb-5">
            ...
            <div class="reca-div mt-3">
                <div id="mobile-number" class="ml-auto mr-auto col-6 mt-2 mb-4 verify h5"><i class="fa fa-phone ml-3 mr-3 text-success"></i> {{$clinic['phoneNumber']}}</div>
                <div class="mt-2 font-weight-bold">Get a Verification code to</div>
                <div id="mobile-number" class="mt-2">Patient History Will Send a Verification code to {{$clinic['phoneNumber']}}</div>
                <button class="h5 btn btn-success mt-5 mb-3" onclick="phoneAuth();">Send Mobile</button>
                <div id="recaptcha-container"></div>
            </div>
            <p class="alert alert-danger danger-Reg" style="display: none"></p>
            <p style="display:none" class="mt-3 alert alert-success suc-Reg">Success Reigster <a href="{{route('clinic_verifcationCode',$clinic['id'])}}">Please Login your Activate .. </a></p>
            ...
            <div class="verfy-email mt-5">
                ...
                @endif
                <a class="col-6 mt-3 btn btn-primary" href="{{route('clinic_send_email',$clinic['id'])}}"><i class="fa fa-envelope mr-2" aria-hidden="true"></i> Verify Email</a>
                {{-- <div>
