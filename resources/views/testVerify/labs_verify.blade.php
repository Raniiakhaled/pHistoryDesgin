    ...
    <div class="container-fluid row no-gutters mt-5 mb-3 bg-message">
        ...
        <div class="col-lg-6 paddingT order-lg-1 mt-5 mb-5">
            ...
            <div class="reca-div mt-3">
                <div id="mobile-number" class="ml-auto mr-auto col-6 mt-2 mb-4 verify h5"><i class="fa fa-phone ml-3 mr-3 text-success"></i> {{$labs['phoneNumber']}}</div>
                <div class="mt-2 font-weight-bold">Get a Verification code to</div>
                <div id="mobile-number" class="mt-2">Patient History Will Send a Verification code to {{$labs['phoneNumber']}}</div>
            ...
            <p style="display:none" class="mt-3 alert alert-success suc-Reg">Success Reigster <a href="{{route('labs_verifcationCode',$labs['id'])}}">Please Login your Activate .. </a></p>
            ...
            <div class="verfy-email mt-5">
                ...
                @endif
                <a class="col-6 mt-3 btn btn-primary" href="{{route('labs_send_email',$labs['id'])}}"><i class="fa fa-envelope mr-2" aria-hidden="true">Verify Email</a>
                {{-- <div>
